...
if __name__ == '__main__':
    ...
    parser.add_argument('--spread1', type=float)
    ...
    parser.add_argument('--spread2', type=float)
    ...
    parser.add_argument('--spread3', type=float)
    ...
    parser.add_argument('--spread4', type=float)
    ...
    parser.add_argument('--spread5', type=float)
