...
def func():
    ...
    # ファイルを出力する。
    randomwalk1.to_csv('~/historical_data/RANDOMWALK1.csv')
    randomwalk2.to_csv('~/historical_data/RANDOMWALK2.csv')
    randomwalk3.to_csv('~/historical_data/RANDOMWALK3.csv')
    randomwalk4.to_csv('~/historical_data/RANDOMWALK4.csv')
    randomwalk5.to_csv('~/historical_data/RANDOMWALK5.csv')
    randomwalk6.to_csv('~/historical_data/RANDOMWALK6.csv')
    randomwalk10.to_csv('~/historical_data/RANDOMWALK10.csv')
    randomwalk12.to_csv('~/historical_data/RANDOMWALK12.csv')
    randomwalk15.to_csv('~/historical_data/RANDOMWALK15.csv')
    randomwalk20.to_csv('~/historical_data/RANDOMWALK20.csv')
    randomwalk30.to_csv('~/historical_data/RANDOMWALK30.csv')
    randomwalk60.to_csv('~/historical_data/RANDOMWALK60.csv')
    randomwalk120.to_csv('~/historical_data/RANDOMWALK120.csv')
    randomwalk180.to_csv('~/historical_data/RANDOMWALK180.csv')
    randomwalk240.to_csv('~/historical_data/RANDOMWALK240.csv')
    randomwalk360.to_csv('~/historical_data/RANDOMWALK360.csv')
    randomwalk480.to_csv('~/historical_data/RANDOMWALK480.csv')
    randomwalk720.to_csv('~/historical_data/RANDOMWALK720.csv')
    randomwalk1440.to_csv('~/historical_data/RANDOMWALK1440.csv')
